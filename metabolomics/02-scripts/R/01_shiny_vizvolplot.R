...
open_maaslin_file <- function(maaslin_type){
  assign(paste0("lipid_tl1a_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_lipid_tl1a_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("amines_tl1a_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_amines_tl1a_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("gcms_tl1a_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_gcms_tl1a_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  
  assign(paste0("lipid_il10_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_lipid_il10_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("amines_il10_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_amines_il10_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("gcms_il10_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_gcms_il10_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  
  assign("lipid_pp_il10", read_csv(paste0("03-data/intermediate_data/final_maaslin/01_lipid_il10_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("amines_il10_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_amines_il10_maaslin_", maaslin_type, ".csv")),
         envir = parent.frame())
  assign(paste0("gcms_il10_", maaslin_type), read_csv(paste0("03-data/intermediate_data/final_maaslin/01_gcms_il10_maaslin_", maaslin_type, ".csv")),
  ...
  namelist <- c(paste0("lipid_tl1a_", maaslin_type), paste0("amines_tl1a_", maaslin_type),
                paste0("gcms_tl1a_", maaslin_type), paste0("lipid_il10_", maaslin_type),
                paste0("amines_il10_", maaslin_type), paste0("gcms_il10_", maaslin_type))
  
  return(namelist)
}

open_maaslin_file("wointeractinfl")
open_maaslin_file("onlyinfl")

lipid_maaslin_tl1a <- lipid.df.tl1a
amines_maaslin_tl1a <- amines.df.tl1a
gcms_maaslin_tl1a <- primeta.df.tl1a


dflist <- c("lipid_maaslin_tl1a", "amines_maaslin_tl1a", "gcms_maaslin_tl1a")
...
server <- function(input, output){
  ...
  linmod_df <- eventReactive(input$data_choice, {
    name <- paste0(strsplit(input$data_choice, "_")[[1]][1], "_", strsplit(input$data_choice, "_")[[1]][3],
                   "_wointeractinfl") #change file of linear model to use here
    get(name)
  })
